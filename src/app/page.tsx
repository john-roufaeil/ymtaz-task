    ...
    return (
        <main className="flex min-h-screen flex-col items-center py-4 px-12 bg-c_background">
            ...
            <div className='w-4/5 mx-auto flex flex-wrap justify-center gap-6 mb-16'>
                <button className="group hover:bg-gradient-to-br hover:from-c_start hover:to-c_end aspect-square w-1/2 card p-4 rounded-lg transition duration-300 ease-in-out cursor-pointer  items-center justify-center flex flex-col p-4 w-full sm:w-1/3 lg:w-1/4">
